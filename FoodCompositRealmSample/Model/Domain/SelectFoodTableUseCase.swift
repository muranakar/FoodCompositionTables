...
struct SelectFoodObject {
    var food: FoodCompositionObject
    var weight: Double
}
...
class SelectFoodTableUseCase {
    ...
    func add(selectFood: SelectFoodObject, to foodList:[SelectFoodObject])  -> [SelectFoodObject] {
        var foodList = foodList
        foodList.append(selectFood)
        return foodList
    }
    
    func delete(selectFood: SelectFoodObject, from foodList: [SelectFoodObject]) -> [SelectFoodObject]{
        var foodList = foodList
